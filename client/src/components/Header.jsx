...
const Header = () => {
  ...
  return (
    ...
    text-gray-800'>
        ...
        <h1 className='flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2'>Hi {userData ? userData.name:' Developer'}! <img className='w-8 aspect-square' src={assets.hand_wave} alt="" /></h1>
